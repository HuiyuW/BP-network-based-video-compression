...
psnr_intrag = calcPSNR(image_YCbCr{1}, image_rec);
...
hold on
plot(bpp_intermean, psnr_intermean,'d-','MarkerFaceColor','b','MarkerEdgeColor','k')
hold on
...
hold on
plot(bpp_intermean2, psnr_intermean2,'d-','MarkerFaceColor','g','MarkerEdgeColor','k')
% hold on
